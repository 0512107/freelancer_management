<?php 
	$arr['pageTitle'] = "Dashboard";
	$arr['pluginsCSS'] = array(
		HTTP_LIB_PATH . "fullcalendar/fullcalendar.min.css"
	);
...
<?php 
	$arr['pluginsJquery'] = array(
		HTTP_LIB_PATH . "jquery.sparkline/jquery.sparkline.min.js",
		HTTP_LIB_PATH . "flot/jquery.flot.js",
		HTTP_LIB_PATH . "flot/jquery.flot.selection.js",
		HTTP_LIB_PATH . "flot/jquery.flot.resize.js",
		HTTP_LIB_PATH . "jquery.tablesorter/jquery.tablesorter.min.js",
		HTTP_LIB_PATH . "moment/moment.min.js",
		HTTP_LIB_PATH . "fullcalendar/fullcalendar.min.js",
		HTTP_JS_PATH . "dashboard.js"
	);
